# sex age stratified rf 2026 09 14
...
- [forest.py](forest.py): Small prespecified forest grid on training-selected DE masks.
- [launch.py](launch.py): Verified cached-DE random forests on unchanged demographic holdouts.
...
- [reporting.py](reporting.py): Paired RF-minus-ridge comparisons using the original bootstrap draws.
