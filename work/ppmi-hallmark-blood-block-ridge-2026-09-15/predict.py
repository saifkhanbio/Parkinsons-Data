"""Apply a trusted local Hallmark/blood model to aligned metadata and optional counts."""
import argparse
from pathlib import Path
import joblib
import numpy as np
import pandas as pd
from blood_models import predict_artifact

p=argparse.ArgumentParser()
p.add_argument("--model",required=True)
p.add_argument("--metadata",required=True,help="TSV: PATNO plus WBC and differential percentages in the original units for blood models")
