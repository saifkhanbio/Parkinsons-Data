...
- [launch.py](launch.py): Validate and launch the controlled mapped-gene RBF-SVM comparison.
- [mapped_svm.py](mapped_svm.py): RBF-SVM using the preserved, unsupervised mapped-gene preprocessing.
- [predict.py](predict.py): Apply a trusted local SVM artifact to complete, matching raw gene counts.
