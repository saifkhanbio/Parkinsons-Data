# mapped gene classifier 2026 09 12
...
- [launch.py](launch.py): Launch RNA-only classifiers on the fixed 4,376-gene Hallmark union.
- [mapped_genes.py](mapped_genes.py): Individual RNA predictors restricted to the fixed Hallmark gene union.
