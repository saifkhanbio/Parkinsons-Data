# ridge intergenic adjustment 2026 09 15
...
- [adjustment.py](adjustment.py): Partition-specific, outcome-blind removal of one technical expression component.
- [launch.py](launch.py): Launch once, detached; status is checked only on user request.
- [predict.py](predict.py): Apply a trusted local model with full count universe and aligned technical QC.
