# hallmark pathway catboost 2026 09 14
...
- [predict.py](predict.py): Apply the local pathway model to complete matching raw counts.
- [run.py](run.py): Frozen-split CatBoost comparison using training-only Hallmark pathway scores.
